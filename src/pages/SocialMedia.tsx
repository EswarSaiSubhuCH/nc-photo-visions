      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {socialPlatforms.map((platform) => (
            <div
              key={platform.name}
              className="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-6 relative"
            >
              {/* Icon */}
              ...
              {/* Followers badge */}
              <div className="absolute top-4 right-4 text-sm bg-gray-100 text-gray-600 px-3 py-1 rounded-full">
                {platform.followers}
              </div>
              ...
              <a
                ...
                className="inline-block px-4 py-2 rounded-full bg-orange-100 text-orange-600 font-medium hover:bg-orange-200 transition"
              >
                Visit
              </a>
            </div>
