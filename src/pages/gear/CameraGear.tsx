  ...
  const cameras = [
    {
      ...
      link: "https://ibb.co/wr6xXtK3", // Clickable image link
      name: "Sony Alpha ILCE-7RM3A",
      description: "The Sony Alpha ILCE-7RM3A is a full-frame mirrorless camera with unmatched resolution and speed, ideal for professional photographers capturing landscapes, portraits, and fast-moving subjects.",
      specifications: [
        "42.4MP Full-frame Exmor R CMOS Sensor",
        "5-axis in-body image stabilization",
        "10fps continuous shooting",
        "4K video recording in XAVC S format",
        "693-point Fast Hybrid Autofocus with Eye AF",
          ...
          {cameras.map((camera) => (
            ...
            >
              <div className="aspect-[4/3] relative mb-4 rounded-xl overflow-hidden">
                {/* Make the first camera image clickable */}
                {camera.link ? (
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">{camera.description}</p>
