  ...
  const lenses = [
    {
      ...
      description: "High-performance prime lens designed for portrait photography. Offers exceptional sharpness, smooth bokeh, and excellent low-light performance.",
      specifications: [
        "85mm Fixed Focal Length",
        "f/1.4 Maximum Aperture",
        "Ultra Multi-Coating (UMC) for reduced flare and ghosting",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Professional lenses that bring creative vision to life. From versatile zooms to specialized primes, each lens offers unique capabilities for different shooting scenarios.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {lenses.map(lens => (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">{lens.description}</p>
