  ...
  const images = [
    {
      ...
      description: "Clean, professional portrait perfect for business use",
      camera: "Canon EOS R5",
    ...
    },
    {
      ...
      description: "Artistic portrait with dramatic lighting and composition",
      camera: "Canon EOS R6",
    ...
    },
    {
      ...
      description: "Warm family portrait capturing genuine connections",
      camera: "Canon EOS R5",
    ...
    },
    {
      ...
      description: "Memorable graduation portrait in natural setting",
      camera: "Canon EOS R6",
      settings: "85mm, f/2.0, 1/200s, ISO 100"
    }
  ];
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-12 border border-white/10 backdrop-blur-sm">
          <h2 className="text-3xl font-playfair font-bold mb-4">Ready for Your Portrait Session?</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let's create professional portraits that represent the best version of you. 
            Contact us to schedule your personalized portrait session.
          </p>
