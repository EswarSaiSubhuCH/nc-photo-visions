...
const PortraitGallery = () => {
  ...
  const albums = [
    ...
    },
    {
      ...
      title: "Album 2",
      description: "",
      coverImage: album2Images[0],
      imageCount: album2Images.length,
      images: album2Images.map((src, index) => ({
        id: index + 1,
        src,
        title: `Photo ${index + 1}`,
        description: "",
    ...
    },
    {
      ...
      title: "Album 3",
      description: "",
      coverImage: album3Images[0],
      imageCount: album3Images.length,
      images: album3Images.map((src, index) => ({
        id: index + 1,
        src,
        title: `Photo ${index + 1}`,
        description: "",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Professional portraits that capture personality and character. From business headshots to family portraits, we create images that tell your unique story.
          </p>
