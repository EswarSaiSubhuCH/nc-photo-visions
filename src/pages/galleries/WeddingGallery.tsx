    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-12 border border-white/10 backdrop-blur-sm">
          <h2 className="text-3xl font-playfair font-bold mb-4">Planning Your Dream Wedding?</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let us capture your special day with the artistry and attention it deserves. 
            Contact us to discuss your wedding photography package.
          </p>
