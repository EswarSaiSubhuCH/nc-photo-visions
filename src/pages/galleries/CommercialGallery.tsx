      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {images.map((image) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500/20 to-teal-500/20 backdrop-blur-sm border border-white/10 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-500/20">
        ...
        <div className="text-center bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-12 border border-white/10 backdrop-blur-sm">
          <h2 className="text-3xl font-playfair font-bold mb-4">Need Commercial Photography?</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Elevate your business with professional photography that showcases your products, 
            services, and brand in the best possible light.
          </p>
